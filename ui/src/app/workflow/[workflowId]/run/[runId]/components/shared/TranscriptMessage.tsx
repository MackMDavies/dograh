...
export function TranscriptMessage({ message, nextMessage }: TranscriptMessageProps) {
        ...
        return (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-amber-500/10 border border-amber-500/20">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <a
                        href="https://docs.xpandagent.com/configurations/interruption"
                        target="_blank"
    ...
    if (message.type === 'pipeline-error') {
        const isCredentialError = /403|401|api key|service key|forbidden|unauthorized/i.test(message.text);
        return (
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {isCredentialError && (
                        <a
                            ...
                            className="inline-flex items-center gap-1 text-xs text-red-600 dark:text-red-400 hover:underline mt-1.5"
                        >
